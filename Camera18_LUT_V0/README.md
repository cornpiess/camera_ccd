...
- Absolute Hero (original approximation of the 像素蛋糕 140501「绝对主角」vivid-glossy direction;
  generated by `generate-absolute-hero.js` — edit + regenerate, then copy to `modules/camera-engine/ios/LUTs/`)
